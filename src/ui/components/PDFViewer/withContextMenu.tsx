...
const withContextMenu: WrappingFunction = (WrappedComponent) =>
  observer((props) => {
    ...
    //         }}
    //       >
    //         {localState.menu.items.map((item: any) => {
    //           let bgcolor = item.isHover ? '#336699' : '#333333'
    //           return (
    //             <Box
    //               sx={{
    ...
    //                     let bgcolor = child.isHover ? '#336699' : '#333333'
    //                     return (
    //                       <Box
    //                         sx={{
    //                           position: 'absolute',
    ...
    //                           bgcolor,
    //                         }}
    //                         onClick={() => (child.open = !child.open)}
    //                         onMouseOver={() => onMouseOverMenu(child)}
    //                         onMouseLeave={() => onMouseLeaveMenu(child)}
    //                       >
    //                         {child.text}
    //                       </Box>
    //                     )
